...
+ (BOOL)validateMobile:(NSString *)mobile
{
    ...
    NSString *phoneRegex = @"^1(3[0-9]|4[579]|5[0-35-9]|8[0-9]|7[03678]|9[9]|6[6])\\d{8}$";
...
//判断是否为整形：
- (BOOL)isPureInt:(NSString*)targetString{
    
    NSScanner* scan = [NSScanner scannerWithString:targetString];
...
//判断是否为浮点形：
- (BOOL)isPureFloat:(NSString*)targetString{
