...
-(void)backBtnClicked{
    ...
    if ([self.webView canGoBack] && (![self.webView.title isEqualToString:@"钱包"] &&![self.webView.title isEqualToString:@"我要分享"]&&![self.webView.title isEqualToString:@"我的消息"]&&![self.webView.title isEqualToString:@"我的主页"])) {
        [self.webView goBack];
    }else{
        [super backBtnClicked];
    }
